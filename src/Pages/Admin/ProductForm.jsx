...
const ProductForm = ({ isOpen, onClose, onSave, editData }) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (editData) {
        await axios.post(`${API_BASE_URL}/updateproduct`, { id: form.id, ...payload });
      } else {
        await axios.post(`${API_BASE_URL}/addproduct`, payload);
      }
        ...
        <div className="form-grid">
          ...
          <div className="details-form">
            ...
            <div className="checkbox-group">
              ...
              <label><input type="checkbox" name="preorder" checked={!!form.preorder} onChange={handleInput} /> Pre-Order</label>
              <label><input type="checkbox" name="premiumOnly" checked={!!form.premiumOnly} onChange={handleInput} /> Premium Only</label>
            </div>
